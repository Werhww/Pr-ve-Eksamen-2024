...
import type { PersonalInfo, Student } from "@prisma/client"

type StudentRow = Student & { personal: PersonalInfo | null }
...
const prop = defineProps<{
	rows: NoServerFunctionErrors<ServerFunctionResult<"createStudent">[]>
	title: string
}>()
...
<template>
	...
	>
		...
		<template #top-right>
			<QBtn label="Ny elev" @click="$emit('newStudent')" />
		</template>
	</QTable>
</template>
